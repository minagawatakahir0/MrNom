...
/**
 * Created by Takahiro on 2015/12/13.
 */
public class AndroidGraphic  implements Graphics{
    Canvas canvas;
    AssetManager assets;
    Bitmap frameBuffer;
    Paint paint;
    ...
    public void clear(int color) {
        ...
        // colorパラメータ（32ビットARGB）から赤、緑、青の成分を取り出し、CanvasクラスのdrawRGBメソッドを呼び出す
        // 仮想フレームバッファを指定された色で塗りつぶす
